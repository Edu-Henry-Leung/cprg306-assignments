            ...
            <div className="flex rounded w-1/2 m-5 bg-white justify-center">
                <form className="p-6" onSubmit={handleSubmit}>
                    <div className="px-3 mb-4">
                        ...
                        <input className={nameTouched && name === ""? 'rounded border border-red-500 bg-gray-100 text-black'
                            :'rounded border border-black bg-gray-100 text-black'} type="text" name="name" onBlur={handleNameTouched} value={name} onChange={handleNameChange} required/>
                        <p className="text-red-500">{nameTouched && name === "" && 'Item Name is empty!'}</p>
                    </div>
                    ...
                    <div className="flex justify-center">
                        <button className="rounded p-2 bg-sky-300 disabled:bg-gray-200 disabled:cursor-not-allowed disabled:text-gray-400 text-black font-bold" disabled={name === ""}type="submit" value="Add Item">Add Item</button>
                    </div>
